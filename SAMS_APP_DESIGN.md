...
| v1.10.0 | 2026-08-01 | **Complete Audit System — G5-G6-G7-G9 + Tiers 2-3-5 + G10.** 5 new models, 13 API routes, 5 components, 7 assessment tabs. Audit checklist infrastructure, template CRUD admin, workflow bar, printable report, quick-find, voice notes, auto-adopt. **G10:** AI audit analysis via DeepSeek v4 — executive summary, pattern analysis, risk assessment, recommendations. DeepSeek queue processor mapped 16 requirements to controls. 22 design principles. |
