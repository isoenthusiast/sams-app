...
**Last Updated:** September 04, 2026 (v1.17.0 — SAMS-011: public read-only API — company-scoped bearer keys; v1.16.4 — SAMS-013: Transcript → Evidence Chain, human-confirmed extraction + v1.16.4 — SAMS-009: outbound notifications — per-company webhook transport + sweep + weekly digest; v1.16.3 — SAMS-010: white-label theming review fixes)
---
