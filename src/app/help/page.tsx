    ...
    <div className="mx-auto max-w-3xl px-4 py-6">
      ...
      <div className="space-y-6">
        ...
        <Card title="🎬 Demo — Leadership Walkthrough" padding="sm">
          ...
          <a href="/help?topic=demo" className="text-sm text-blue-600 hover:underline mt-2 inline-block">🎬 View Demo →</a>
        </Card>
...
function DemoContent() {
  return (
    <div className="mx-auto max-w-5xl px-4 py-8">
      ...
      <DemoSection title="Part 1 — Why do we need SAMS?" icon="🩺" />

      <PainCard number="1" title="No single repository for assurance results"
      ...
      <PainCard number="2" title="Inconsistent methods, no standard workflow"
      ...
      <PainCard number="3" title="Broken traceability — we cannot connect the dots"
      ...
      {/* PART 2 — THE SOLUTION */}
      <DemoSection title="Part 2 — How SAMS solves this" icon="🔧" />

      <StepCard step="2.1" title="A single source of truth for all process areas"
      ...
      <StepCard step="2.2" title="Standardised frontline assurance workflow"
      ...
      <StepCard step="2.3" title="Controls mapped to requirements — full traceability"
      ...
      <StepCard step="2.4" title="Samples collected, verified on desktop and in the field"
      ...
      <StepCard step="2.5" title="Findings captured, actions tracked to closure"
      ...
      <DemoSection title="Part 3 — Demonstrating Management in Control" icon="🛡️" />
      ...
      {/* PART 4 — THE JOURNEY */}
      <DemoSection title="Part 4 — The Journey from Here to There" icon="🗺️" />
...
function DemoSection({ title, icon }: { title: string; icon: string }) {
  return (
