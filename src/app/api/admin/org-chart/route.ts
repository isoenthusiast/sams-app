...
export async function GET(request: Request) {
  ...
  const rows = await prisma.$queryRawUnsafe<Array<{
    ...
    `WITH RECURSIVE org AS (
      SELECT u.username, u.name, u.email, u.role::text, u."preferredName",
    ...
    GROUP BY o.username, o.name, o.email, o.role, o."preferredName", o."positionTitle", o."departmentName", o."organisationIndicator", o."managerUsername", o.depth
