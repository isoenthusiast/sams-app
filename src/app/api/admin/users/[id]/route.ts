...
export async function PUT(
  ...
  try {
    ...
    const { name, username, email, role, companyIds, password, managerName, managerUsername, organisationIndicator, positionId, preferredName, active } = body;
    ...
    if (preferredName !== undefined) { fields.push(`"preferredName" = $${idx++}`); values.push(preferredName || null); }
